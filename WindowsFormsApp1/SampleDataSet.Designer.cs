...
namespace WindowsFormsApp1.SampleDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([login] = @Original_login) AND ([psw] = @Origin" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [login] = @login, [psw] = @psw, [role] = @role, [name] = @name WHERE (([login] = @Original_login) AND ([psw] = @Original_psw) AND ([role] = @Original_role) AND ([name] = @Original_name));
SELECT login, psw, role, name FROM Users WHERE (login = @login)";
